...
# Configuration
WIDTH=2160  # 1368 for iPad Pro
HEIGHT=1440  # 1024 for iPad Pro
MODE_NAME="surface_remote"       # Set whatever name you like, you may need to change
...
echo $CLIP_POS
# Share screen
x11vnc -repeat -clip $CLIP_POS -passwd lalala
